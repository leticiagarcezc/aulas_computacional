...
```{r echo=FALSE, out.width='70%', fig.align = "center", fig.cap = "Linus Torvalds em uma conferência para o [**TED**](https://www.ted.com/talks/linus_torvalds_the_mind_behind_linux?language=pt-br) intitulada **A mente por trás do Linux**, 2016."}
