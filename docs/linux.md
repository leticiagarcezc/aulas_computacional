...
<img src="images/linus_torvalds.jpg" alt="Linus Torvalds em uma conferência para o [**TED**](https://www.ted.com/talks/linus_torvalds_the_mind_behind_linux?language=pt-br) intitulada **A mente por trás do Linux**, 2016." width="70%" />
<p class="caption">(\#fig:unnamed-chunk-5)Linus Torvalds em uma conferência para o [**TED**](https://www.ted.com/talks/linus_torvalds_the_mind_behind_linux?language=pt-br) intitulada **A mente por trás do Linux**, 2016.</p>
</div>
