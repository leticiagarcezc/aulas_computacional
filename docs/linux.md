...
Para que um sistema operacional venha ser utilizado pela maioria das pessoas, em que nesse grupo nos incluímos, deve conter diversos outros programas e recursos além do kernel propriamente dito. Para nós que trabalhamos com estatístca, por exemplo, precisamos de ter a nossa disposição outras linguagens de programação além de C, como R, C++, Java e Python, IDEs (**Integrated Development Environment**) para programação, softwares para escrita de relatórios, sistemas de gerenciamento de banco de dados, entre outros programas de interesse. 
